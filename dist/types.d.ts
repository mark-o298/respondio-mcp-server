...
export type MessageType = "text" | "attachment" | "whatsapp_template" | "email" | "quick_reply" | "custom_payload";
...
export type Message = TextMessage | AttachmentMessage | EmailMessage | WhatsAppTemplateMessage | QuickReplyMessage | CustomPayloadMessage;
export type MessagePayload = TextMessage | AttachmentMessage | EmailMessage | WhatsAppTemplateMessage;
...
export interface Channel {
    id: number;
    name: string;
    source: "facebook" | "instagram" | "line" | "telegram" | "viber" | "twitter" | "wechat" | "custom_channel" | "gmail" | "other_email" | "twilio" | "message_bird" | "nexmo" | "360dialog_whatsapp" | "twilio_whatsapp" | "message_bird_whatsapp" | "whatsapp" | "nexmo_whatsapp" | "whatsapp_cloud";
    created_at: number;
}
...
export type ToolHandler = (args: ToolArgs, ctx?: unknown) => Promise<CallToolResult> | CallToolResult;
