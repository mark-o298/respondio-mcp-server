...
const templateComponentSchema = z.object({
    ...
    parameters: z
        ...
        .optional()
        .describe("Dynamic variable values for the component. Use one parameter per template variable ({{1}}, {{2}}, etc.)."),
    buttons: z
        .array(z.object({
        type: z
    ...
    tools = [
        {
            ...
            schema: {
                ...
                channelId: z
                    ...
                    .nullable()
                    .optional()
                    .describe("The channel ID to send the message from. If null, the last interacted channel will be used."),
                messageType: z
                ...
                templateName: z
                    .string()
                    .optional()
                    .describe("The name of the WhatsApp template, required for 'whatsapp_template' message types."),
                templateLanguage: z
                    .string()
                    .optional()
                ...
                templateComponents: z
                    ...
                    .optional()
                    .describe("Dynamic components for the WhatsApp template. Use this to fill in variable values " +
            ...
            handler: async (args, ctx) => {
                const { identifier, channelId, messageType, ...messageData } = args;
                try {
                    ...
                    switch (messageType) {
                        case "text":
                            message = { type: "text", text: messageData.text };
                            break;
                        case "attachment":
                            message = {
                                type: "attachment",
                        ...
                        case "whatsapp_template":
                            message = {
                                ...
                                template: {
                                    ...
                                    languageCode: messageData.templateLanguage,
        ...
        },
        {
            ...
            handler: async (args, ctx) => {
                const { identifier, messageId } = args;
                try {
                    const sdkClient = createSdkClient(this.apiBaseUrl, this.mode, ctx);
                    const formattedIdentifier = formatContactIdentifier(identifier);
        ...
        },
        {
            ...
            handler: async (args, ctx) => {
                const { identifier, limit = 20, cursorId, } = args;
                try {
                    const sdkClient = createSdkClient(this.apiBaseUrl, this.mode, ctx);
                    const formattedIdentifier = formatContactIdentifier(identifier);
